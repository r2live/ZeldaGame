 ...
 * 
 * @author Rohith Perla
 * Knight class - One of the smaller monsters that Link must defeat in order to face Ganon
 */

public class Knight implements MonsterShape {
	...
	private Image[] knight = new Image[2];
	...
	public Knight(short screenData[][], int brd_x, int brd_y, int blockwidth) {//Constructor
	...
	public void draw(Graphics2D g2d) {//Draws the monster
		if (alive == true)
			g2d.drawImage(knight[spriteImgIdx], x + 1, y + 1, null);
	}

	public void loadImages() {//Images to animate the monster
		knight[0] = new ImageIcon("Images/Knight/KnightD1.png").getImage();
		knight[1] = new ImageIcon("Images/Knight/KnightD2.png").getImage();
	}
