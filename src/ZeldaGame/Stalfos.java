 ...
 * 
 * @author Rohith Perla
 * Stalfos class - One of the smaller monsters that Link must defeat in order to face Ganon
 * 
 */

public class Stalfos implements MonsterShape{
	...
	private Image[] stalfos = new Image[2];
	...
	public Stalfos(short screenData[][], int brd_x, int brd_y, int blockwidth) {//Constructor
	...
	public void draw(Graphics2D g2d) {//Draws the monster
		if (alive == true)
			g2d.drawImage(stalfos[spriteImgIdx], x + 1, y + 1, null);
	}

	public void loadImages() {//Images to animate the monster
		stalfos[0] = new ImageIcon("Images/Stalfos/Stalfos1.png").getImage();
		stalfos[1] = new ImageIcon("Images/Stalfos/Stalfos2.png").getImage();
	}
