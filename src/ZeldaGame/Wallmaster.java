 ...
 * 
 * @author Rohith Perla
 * Wallmaster class - One of the smaller monsters that Link must defeat in order to face Ganon
 *
 */

public class Wallmaster implements MonsterShape {
	...
	private Image[] wallmaster = new Image[2];
	...
	public Wallmaster(short screenData[][], int brd_x, int brd_y, int blockwidth) {//Constructor
	...
	public void draw(Graphics2D g2d) {//Draws the monster
		if (alive == true)
			g2d.drawImage(wallmaster[spriteImgIdx], x + 1, y + 1, null);
	}

	public void loadImages() {//Images to animate the monster
		wallmaster[0] = new ImageIcon("Images/Wallmaster/Wallmaster1.png").getImage();
		wallmaster[1] = new ImageIcon("Images/Wallmaster/Wallmaster2.png").getImage();
	}
