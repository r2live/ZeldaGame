 ...
 * 
 * @author Rohith Perla
 * Moblin class - One of the smaller monsters that Link must defeat in order to face Ganon
 *
 */

public class Moblin implements MonsterShape{
	...
	private Image[] moblin = new Image[2];
	...
	public Moblin(short screenData[][], int brd_x, int brd_y, int blockwidth) {//Constructor
	...
	public void draw(Graphics2D g2d) {//Draws the monster
		if (alive == true)
			g2d.drawImage(moblin[spriteImgIdx], x + 1, y + 1, null);
	}

	public void loadImages() {//Images to animate the monster
		moblin[0] = new ImageIcon("Images/Moblin/MoblinD1.png").getImage();
		moblin[1] = new ImageIcon("Images/Moblin/MoblinD2.png").getImage();
	}
